...
if ( app.documents.length != 0 )
{
    ...
    grosimeCotor = grosimeCotor + 3;
    extraCotor = 13;
    var lungime_cop = 200;
    var latime_cop = 303;
    var margine_sus_jos = 13;
    var lungime_ghid = 7;
    var distTaiereColt = 5;
	// =======================================================

	//Change canvas size
    var CANVASX = (lungime_cop+margine_sus_jos + extraCotor) * 2 + grosimeCotor;
    var CANVASY = 330;
	...
	//Add rullers
	// =======================================================
     doc.guides.add ( Direction.VERTICAL , margine_sus_jos );
	doc.guides.add ( Direction.VERTICAL , margine_sus_jos + lungime_cop );
    doc.guides.add ( Direction.VERTICAL , margine_sus_jos + lungime_cop + extraCotor);
    doc.guides.add ( Direction.VERTICAL , margine_sus_jos + lungime_cop + extraCotor + grosimeCotor);
	doc.guides.add ( Direction.VERTICAL , margine_sus_jos + lungime_cop + grosimeCotor + (extraCotor * 2) );
     doc.guides.add ( Direction.VERTICAL , margine_sus_jos + lungime_cop + grosimeCotor + (extraCotor * 2) + lungime_cop );
    ...
    //STANGA SUS
	var posPixX1= margine_sus_jos*doc.resolution/25.4;
	var posPixX2= margine_sus_jos*doc.resolution/25.4;
    ...
    //CENTRU STANGA SUS
	var posPixX1= (margine_sus_jos + lungime_cop)*doc.resolution/25.4;
	var posPixX2= (margine_sus_jos + lungime_cop)*doc.resolution/25.4;
	var posPixY1= 0*doc.resolution/25.4;
	var posPixY2= lungime_ghid*doc.resolution/25.4;   
	...
	var posPixX1= (margine_sus_jos + lungime_cop+extraCotor)*doc.resolution/25.4;
	var posPixX2= (margine_sus_jos + lungime_cop+extraCotor)*doc.resolution/25.4;
	var posPixY1= 0*doc.resolution/25.4;
	var posPixY2= lungime_ghid*doc.resolution/25.4;
	...
	var posPixX1= (margine_sus_jos + lungime_cop+grosimeCotor + extraCotor)*doc.resolution/25.4;
	var posPixX2= (margine_sus_jos + lungime_cop+grosimeCotor + extraCotor)*doc.resolution/25.4;
	var posPixY1= 0*doc.resolution/25.4;
	var posPixY2= lungime_ghid*doc.resolution/25.4;
    ...
    //CENTRU DREAPTA SUS
	var posPixX1= (margine_sus_jos + lungime_cop+grosimeCotor + extraCotor * 2)*doc.resolution/25.4;
	var posPixX2= (margine_sus_jos + lungime_cop+grosimeCotor + extraCotor * 2)*doc.resolution/25.4;
	var posPixY1= 0*doc.resolution/25.4;
	var posPixY2= lungime_ghid*doc.resolution/25.4;
    ...
    //DREAPTA SUS
	var posPixX1= (margine_sus_jos + lungime_cop+grosimeCotor + extraCotor * 2 + lungime_cop)*doc.resolution/25.4;
	var posPixX2= (margine_sus_jos + lungime_cop+grosimeCotor + extraCotor * 2 + lungime_cop)*doc.resolution/25.4;
	var posPixY1= 0*doc.resolution/25.4;
	var posPixY2= lungime_ghid*doc.resolution/25.4;
    ...
    //LATERAL DREAPTA SUS
	var posPixX1= (margine_sus_jos + lungime_cop+grosimeCotor + extraCotor * 2 + lungime_cop + (margine_sus_jos-lungime_ghid))*doc.resolution/25.4;
	var posPixX2= (margine_sus_jos + lungime_cop+grosimeCotor + extraCotor * 2 + lungime_cop + margine_sus_jos)*doc.resolution/25.4;
