...
if ( app.documents.length != 0 )
{
	...
	//Resize the document
	// =======================================================
	doc.resizeImage(300, 240, 250, ResampleMethod.BICUBIC);
	// =======================================================
	...
	// =======================================================
	var grosimeCotor = Number ( prompt ( 'Grosime cotor (mm):' , 30 ) ) ;
	// =======================================================

	//Change canvas size
	// =======================================================
	doc.resizeImage(600+grosimeCotor, 240, 250, ResampleMethod.BICUBIC);
	// =======================================================

	//Add rullers
	// =======================================================
	doc.guides.add ( Direction.VERTICAL , 300 );
	doc.guides.add ( Direction.VERTICAL , 300 + grosimeCotor );
	doc.guides.add ( Direction.HORIZONTAL , 210);
	// =======================================================

	var cotorEnd = 300+grosimeCotor;
	...
	var posPixY1= 300*doc.resolution/25.4;
